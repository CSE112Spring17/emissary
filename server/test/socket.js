...
//                 if(err) throw(err);
//                 appointment1=a1;
//                 console.log("appt1 ", appointment1);
...
//                     if(err) throw(err);
//                     appointment2=a2
//                     console.log("appt2",appointment2);
//                     client1 = io.connect(socketURL, options);
//                     client1.once("connect", function () {
//                       console.log("company_inside",currCompany);
...
//
//     after(function(done) {
//       console.log("currVisitorList in after",currVisitorList);
